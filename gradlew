...
# The following code has been removed for brevity, as it is not strictly necessary for functionality.
...
# This is an additional check to ensure all variables are properly set
# It's a good practice to have this for debugging purposes
